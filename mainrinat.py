...
# --- Демонстрация полиморфизма с новыми именами ---
if __name__ == "__main__":
    people = [
        Student("Дмитрий Соколов", 20, "IS-23", 4.1),
        Teacher("Елена Викторовна Смирнова", 52, "Математика", 28),
        AdminStaff("Олег Кузнецов", 39, "Системный администратор", "IT-отдел")
    ]
